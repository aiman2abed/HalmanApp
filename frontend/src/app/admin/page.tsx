...
// --- MOCK DATABASE FOR APPROVAL WORKFLOW ---
const MOCK_SUGGESTIONS = [
  {
    id: "sug-1",
    author: "أ. ليلى (مشرفة مختبر الحاسوب)",
    type: "تعديل خطة طالب",
    description: "اقتراح نقل الطالب (أحمد كريم) إلى المستوى المتقدم في مسار هندسة البرمجيات.",
    date: "منذ ساعتين",
    status: "pending"
  },
  {
    id: "sug-2",
    author: "م. سامي (مشرف ورشة الروبوتات)",
    type: "إضافة مشروع جديد",
    description: "إضافة مشروع 'الذراع الآلية' إلى قسم المشاريع التطبيقية لورشة الروبوتات.",
    date: "منذ 5 ساعات",
    status: "pending"
  }
];
...
export default function SchoolAdminPage() {
  ...
  const handleAction = async (id: string, action: "approve" | "reject") => {
    ...
    try {
      ...
      // await supabase.from('content_suggestions').update({ status: newStatus }).eq('id', id);
    } catch (error) {
